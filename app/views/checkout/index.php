            ...
            <div class="col-lg-8">
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>Note</label><br>
                            <textarea name="note" class="form-control" maxlength="300"></textarea>
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <?php }else{
                            echo '<button type="submit" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3" disabled>Place Order</button>';
                        }?>
                    </div>
                </div>
            </div>
